...
class AgenticDataEngineeringPipelineSession(Base):
    __tablename__ = "data_engineering_pipeline_sessions"
...
class AgenticDataEngineeringPipelineItem(Base):
    __tablename__ = "data_engineering_pipeline_items"

    id = Column(String, primary_key=True, index=True)
    session_id = Column(String, ForeignKey("data_engineering_pipeline_sessions.id"))

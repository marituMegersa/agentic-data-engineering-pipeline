...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Data Engineering & Pipeline Debugger</h1>
      <p style={{ color: '#666' }}>Autonomous ETL pipeline monitoring, schema drift detection, automated SQL synthesis, and data quality repair.</p>
